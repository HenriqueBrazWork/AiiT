...
def load_models():
    models = {
        ...
        'audio_classifier': ("audio-classification",), model="facebook/wav2vec2-large-xlsr-53", device=device),
        'speech_to_text': ("automatic-speech-recognition", model="facebook/wav2vec2-large-xlsr-53", device=device),
