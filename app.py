...
def load_models():
    models = {
        ...
        'audio_classifier': ("audio-classification",processor = AutoProcessor.from_pretrained("facebook/wav2vec2-large-xlsr-53"), model="facebook/wav2vec2-large-xlsr-53", device=device),
        'speech_to_text': ("automatic-speech-recognition",processor = AutoProcessor.from_pretrained("facebook/wav2vec2-large-xlsr-53"), model="facebook/wav2vec2-large-xlsr-53", device=device),
